...
namespace JCITool
{
    ...
    public class RobotoTextFactory : Java.Lang.Object, LayoutInflater.IFactory
    {
        ...
        public View OnCreateView(string name, Android.Content.Context context, IAttributeSet attrs)
        {
        ...
        private TextView CreateView(string name, Android.Content.Context context, IAttributeSet attrs)
        {
        ...
        private Typeface ObtainTypeface(Android.Content.Context context, int typefaceValue)
        {
            try
            {
